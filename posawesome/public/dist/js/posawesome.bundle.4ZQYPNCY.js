(() => {
    ...
    methods: {
      ...
      print_last_duplicate_invoice() {
        frappe.db.get_list("Sales Invoice", {
          filters: { "pos_profile": this.pos_profile.name },
          fields: ["*"],
          ...
          if (!my_invoice["0"]["name"])
            return;
          const print_format = this.pos_profile.print_format_copy;
          const letter_head = this.pos_profile.letter_head || 0;
          const url = frappe.urllib.get_base_url() + "/printview?doctype=Sales%20Invoice&name=" + my_invoice["0"]["name"] + "&trigger_print=1&format=" + print_format + "&no_letterhead=" + letter_head;
          const printWindow = window.open(url, "Print");
          printWindow.addEventListener("load", function() {
            printWindow.print();
          }, true);
  ...
  var __vue_render__ = function() {
    ...
    return _c("nav", [
            ...
            _c("v-card", {
              ...
              _c("v-list", { attrs: { dense: "" } }, [
                _c("v-list-item-group", {
                  ...
                  _vm._v(" "),
                  _vm.pos_profile.allow_print_last_duplicate_invoice ? _c("v-list-item", {
                    on: {
                      click: _vm.print_last_duplicate_invoice
                    }
                  }, [
                    _c("v-list-item-icon", [_c("v-icon", [_vm._v("mdi-printer")])], 1),
                    _vm._v(" "),
                    _c("v-list-item-content", [
                      _c("v-list-item-title", [
                        _vm._v(_vm._s(_vm.__("Print Last Duplicate Invoice")))
                      ])
                    ], 1)
                  ], 1) : _vm._e(),
                  _vm._v(" "),
                  ...
                  _vm._v(" "),
                  _c("v-list-item", { on: { click: _vm.changeProfile } }, [
                    _c("v-list-item-icon", [_c("v-icon", [_vm._v("mdi-account")])], 1),
                    _vm._v(" "),
                    _c("v-list-item-content", [
                      _c("v-list-item-title", [
                        _vm._v(_vm._s(_vm.__("Change POS Profile")))
                      ])
                    ], 1)
                  ], 1),
                  _vm._v(" "),
      ...
      _vm._v(" "),
      _c("v-snackbar", {
        attrs: { timeout: 2e3, color: _vm.snackColor, top: "", right: "" },
        model: {
          value: _vm.snack,
          callback: function($$v) {
            _vm.snack = $$v;
  ...
  var __vue_inject_styles__ = function(inject) {
    if (!inject)
      return;
    inject("data-v-148bf4d4_0", { source: "\n.margen-top[data-v-148bf4d4] {\n  margin-top: 0px;\n}\n", map: { "version": 3, "sources": ["../posawesome/posawesome/public/js/posapp/components/Navbar.vue"], "names": [], "mappings": ";AAwUA;EACA,eAAA;AACA", "file": "Navbar.vue", "sourcesContent": [`<template>
  <nav>
...
.margen-top {
  ...
  var __vue_scope_id__ = "data-v-148bf4d4";
  ...
  var __vue_render__2 = function() {
    ...
    return _c("div", [
      _c("v-card", {
        ...
        staticStyle: { "max-height": "77vh", height: "77vh" }
      }, [
        ...
        _c("v-row", { staticClass: "items px-2 py-1" }, [
          _c("v-col", { staticClass: "pb-0 mb-2" }, [
            _c("v-text-field", {
              ref: "debounce_search",
              attrs: {
                dense: "",
                    ...
                    scopedSlots: _vm._u([
                      ...
                      },
                      {
                        ...
                        fn: function(ref) {
                          var item = ref.item;
                          return [
                            _vm._v("\n                  " + _vm._s(_vm.formtFloat(item.actual_qty)) + "\n                ")
                          ];
                        }
                      }
                    ], null, false, 2682212702)
                  })
                ]
              ], 2)
            ]) : _vm._e()
  ...
  var __vue_script__4 = {
    ...
    methods: {
      ...
      add_item(item) {
        ...
        let index = -1;
        if (!this.new_item) {
          index = this.items.findIndex((el) => el.item_code === item.item_code && el.uom === item.uom && !el.posa_is_offer && !el.posa_is_replace);
        }
      ...
      calc_prices(item, value, $event) {
        if (event.target.id === "rate") {
          ...
          if (value < item.price_list_rate) {
            item.discount_amount = (flt(item.price_list_rate) - flt(value)).toFixed(this.currency_precision);
          } else if (value < 0) {
          ...
          if (value < 0) {
            ...
            item.rate = (flt(item.price_list_rate) - flt(item.price_list_rate) * flt(value) / 100).toFixed(this.currency_precision);
            item.discount_amount = (flt(item.price_list_rate) - flt(item.rate)).toFixed(this.currency_precision);
          }
        }
      },
      calc_item_price(item) {
        ...
        if (item.discount_percentage) {
          ...
          item.rate = (flt(item.price_list_rate) - flt(item.discount_amount)).toFixed(this.currency_precision);
        }
      },
      calc_uom(item, value) {
      ...
      ApplyOnTotal(offer) {
        ...
        if ((!this.discount_percentage_offer_name || this.discount_percentage_offer_name == offer.name) && offer.discount_percentage > 0 && offer.discount_percentage <= 100) {
          this.discount_amount = (flt(this.Total) * flt(offer.discount_percentage) / 100).toFixed(this.currency_precision);
  ...
  var __vue_render__4 = function() {
    ...
    return _c("div", [
      ...
      _c("v-card", {
        ...
        staticStyle: { "max-height": "73vh", height: "73vh" }
      }, [
        _c("v-row", { staticClass: "items px-2 py-1", attrs: { align: "center" } }, [
          _vm.pos_profile.posa_allow_sales_order ? _c("v-col", { staticClass: "pb-2 pr-0", attrs: { cols: "6" } }, [_c("Customer")], 1) : _vm._e(),
          _vm._v(" "),
          !_vm.pos_profile.posa_allow_sales_order ? _c("v-col", { staticClass: "pb-2", attrs: { cols: "12" } }, [_c("Customer")], 1) : _vm._e(),
          _vm._v(" "),
          _c("v-col", { staticClass: "pb-2 pr-0", attrs: { cols: "3" } }, [
            _c("v-select", {
              attrs: {
                items: _vm.order_types,
                label: _vm.frappe._("Order Type"),
                dense: "",
                outlined: "",
                "hide-details": ""
              },
              on: {
                change: function($event) {
                  return _vm.order_type_update(_vm.order_type);
                }
              },
              model: {
          ...
          _vm._v(" "),
          _vm.pos_profile.posa_allow_sales_order ? _c("v-col", { staticClass: "pb-2 pr-0", attrs: { cols: "3" } }, [
            _c("v-select", {
              attrs: {
                dense: "",
                "hide-details": "",
        ...
        _vm._v(" "),
        _c("p", { staticStyle: { "font-size": "0.03px" } }, [_vm._v(".")]),
        _vm._v(" "),
        this.order_type == "Dine In" || this.order_type == "Delivery" ? _c("v-row", {
          staticClass: "items px-2 py-1 mt-0 pt-0",
          staticStyle: { height: "7.5vh" },
          attrs: { align: "center" }
        }, [
          this.order_type == "Dine In" ? _c("v-col", {
            staticClass: "pb-0 mb-2 pr-0 pt-0",
            attrs: { cols: "2" }
          }, [
            _c("v-select", {
              attrs: {
                items: _vm.tables_number,
                label: _vm.frappe._("Table"),
                dense: "",
                outlined: "",
                "hide-details": ""
              },
              on: {
                change: function($event) {
                  return _vm.table_number_update(_vm.table_number, $event);
                }
              },
              model: {
          ...
          _vm._v(" "),
          this.order_type == "Delivery" ? _c("v-col", { staticClass: "pb-0 mb-2 pt-0", attrs: { cols: "3" } }, [
            _c("v-text-field", {
              attrs: {
                dense: "",
                outlined: "",
              ...
              on: {
                change: function($event) {
                  return _vm.change_delivery_charges();
                }
              },
              model: {
                value: _vm.change_delivery_charage,
                callback: function($$v) {
                  _vm.change_delivery_charage = $$v;
                },
                expression: "change_delivery_charage"
              }
            })
          ], 1) : _vm._e()
        ], 1) : _vm._e(),
      ...
      _vm._v(" "),
      _c("v-card", { staticClass: "right-btns" }, [
  ...
  var __vue_inject_styles__4 = function(inject) {
    if (!inject)
      return;
    inject("data-v-35105ad5_0", { source: "\n.border_line_bottom[data-v-35105ad5] {\n  border-bottom: 1px solid lightgray;\n}\n.disable-events[data-v-35105ad5] {\n  pointer-events: none;\n}\n", map: { "version": 3, "sources": ["../posawesome/posawesome/public/js/posapp/components/pos/Invoice.vue"], "names": [], "mappings": ";AA+pFA;EACA,kCAAA;AACA;AACA;EACA,oBAAA;AACA", "file": "Invoice.vue", "sourcesContent": [`<template>
  <div>
...
`] }, media: void 0 });
  ...
  var __vue_scope_id__4 = "data-v-35105ad5";
  ...
  var __vue_script__6 = {
    ...
    methods: {
      ...
      load_print_page() {
        const print_format_copy = this.pos_profile.print_format_copy;
        const print_format = this.pos_profile.print_format_for_online || this.pos_profile.print_format;
        const letter_head = this.pos_profile.letter_head || 0;
        ...
        const url2 = frappe.urllib.get_base_url() + "/printview?doctype=Sales%20Invoice&name=" + this.invoice_doc.name + "&trigger_print=1&format=" + print_format_copy + "&no_letterhead=" + letter_head;
        const printWindow = window.open(url, "Print");
        printWindow.addEventListener("load", function() {
          printWindow.print();
        }, true);
        const printWindow2 = window.open(url2, "Print2");
        printWindow2.addEventListener("load", function() {
          printWindow2.print();
        }, true);
      },
      validate_due_date() {
                ...
                if (message2.status != "Paid") {
                  ...
                  evntBus.$emit("show_mesage", {
                    text: __("Payment of {0} received successfully.", [
                      formtCurrency(message2.grand_total, vm.invoice_doc.currency, 0)
                    ]),
                    color: "success"
                  });
    ...
    computed: {
      ...
      diff_payment() {
        let diff_payment = (this.invoice_doc.grand_total - this.total_payments).toFixed(this.currency_precision);
    ...
    created: function() {
      this.$nextTick(function() {
        evntBus.$on("send_invoice_doc_payment", (invoice_doc) => {
          ...
          if (default_payment) {
            default_payment.amount = invoice_doc.grand_total.toFixed(this.currency_precision);
          }
          this.invoice_doc.posa_delivery_date = new Date(Date.now() - new Date().getTimezoneOffset() * 6e4).toISOString().substr(0, 10);
  ...
  var __vue_render__10 = function() {
    ...
    return _c("v-row", { attrs: { justify: "center" } }, [
      ...
      _c("v-dialog", {
        ...
        model: {
          value: _vm.PosProfiles,
          callback: function($$v) {
            _vm.PosProfiles = $$v;
          },
          expression: "PosProfiles"
        }
      }, [
        _c("v-card", [
          _c("v-card-title", [
            _c("span", { staticClass: "headline primary--text" }, [
              _vm._v(_vm._s(_vm.__("Switch POS Profile")))
            ])
          ]),
          _vm._v(" "),
          _c("v-card-text", [
  ...
  function __vue_normalize__11(template, style, script, scope, functional, moduleIdentifier, shadowMode, createInjector, createInjectorSSR, createInjectorShadow) {
    const component = (typeof script === "function" ? script.options : script) || {};
    component.__file = "../posawesome/posawesome/public/js/posapp/components/pos/NewCustomer.vue";
    if (!component.render) {
      component.render = template.render;
      component.staticRenderFns = template.staticRenderFns;
      component._compiled = true;
  ...
  function __vue_normalize__12(template, style, script, scope, functional, moduleIdentifier, shadowMode, createInjector, createInjectorSSR, createInjectorShadow) {
    const component = (typeof script === "function" ? script.options : script) || {};
    component.__file = "../posawesome/posawesome/public/js/posapp/components/pos/EditCustomer.vue";
    if (!component.render) {
      component.render = template.render;
      component.staticRenderFns = template.staticRenderFns;
      component._compiled = true;
  ...
  var __vue_render__17 = function() {
    ...
    return _c("div", { attrs: { fluid: "" } }, [
      ...
      _c("v-row", {
        ...
        }, [_c("ItemsSelector", { ref: "positems" })], 1),
        _vm._v(" "),
        _c("v-col", {
          directives: [
            {
  ...
  var __vue_inject_styles__17 = function(inject) {
    if (!inject)
      return;
    inject("data-v-11ab4630_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: { "version": 3, "sources": [], "names": [], "mappings": "", "file": "Pos.vue" }, media: void 0 });
  };
  var __vue_scope_id__17 = "data-v-11ab4630";
...
.container1 {
  ...
  var __vue_scope_id__18 = "data-v-6d533482";
  ...
  var __vue_component__18 = /* @__PURE__ */ __vue_normalize__18({ render: __vue_render__18, staticRenderFns: __vue_staticRenderFns__18 }, __vue_inject_styles__18, __vue_script__18, __vue_scope_id__18, __vue_is_functional_template__18, __vue_module_identifier__18, false, __vue_create_injector__5, void 0, void 0);
 ...
 */
//# sourceMappingURL=posawesome.bundle.4ZQYPNCY.js.map
